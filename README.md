...
👉 **[Télécharger ou ouvrir le PDF avec les liens actifs en cliquant ici](https://raw.githubusercontent.com/worldchris/Algorithme-transpisition-accords-guitare/main/Algorithme-Transposition-accords-Guitare.pdf)** *(Astuce : Faites un clic droit sur le lien puis "Enregistrer le lien sous..." pour télécharger le document directement sur votre machine).*
